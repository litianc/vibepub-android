...
URL or digest. It becomes the current published manifest entry only when Issue
#26 receives authorization and publishes the actual managed APK. Until then, the
