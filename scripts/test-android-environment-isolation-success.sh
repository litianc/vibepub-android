...
EOF
chmod +x "$TMP_DIR/aapt" "$TMP_DIR/adb" "$TMP_DIR/curl"

AAPT="$TMP_DIR/aapt" ADB="$TMP_DIR/adb" CURL="$TMP_DIR/curl" FAKE_HTTP_LOG="$TMP_DIR/http.log" \
...
if AAPT="$TMP_DIR/aapt" ADB="$TMP_DIR/adb" CURL="$TMP_DIR/curl" FAKE_HTTP_LOG="$TMP_DIR/http.log" \
  FAKE_ADB_LOG="$TMP_DIR/adb.log" FAKE_STATE_DIR="$TMP_DIR" OUTPUT_ROOT="$TMP_DIR/evidence" \
